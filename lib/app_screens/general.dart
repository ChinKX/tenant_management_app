...
import 'package:tenant_management_app/app_screens/maintenance.dart';
import 'package:tenant_management_app/app_screens/profile.dart';
import 'package:tenant_management_app/app_screens/property_details.dart';
import 'package:tenant_management_app/app_screens/tenancy.dart';
import 'package:tenant_management_app/data/data.dart';
...
import 'package:tenant_management_app/utils/screen_size.dart';
  ...
  Widget colorCard(String text, String subtitle, BuildContext context,
    ...
    return GestureDetector(
      onTap: () => Navigator.of(context).push(MaterialPageRoute(
          builder: (_) => text == 'Rental Property'
              ? PropertyDetails(
                  name: name,
                  imgPath: imgPath,
                  rental: rental,
